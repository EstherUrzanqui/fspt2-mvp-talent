...
class App extends React.Component {
  ...
  render(){
    return(
      <div>
         <Navbar>
           <Navbar.Brand><a href= "http://localhost:3000/">COVID Talent</a></Navbar.Brand>
         </Navbar>
         <Carousel>
          <Carousel.Item>
            <Carousel.Caption>
              <h3>Talent from Adidas</h3>
              <p>Adidas employ over 59,000 people. In 2019 we produced over 1.1 billion products and generated sales of € 23.640 billion.</p>
            </Carousel.Caption>
            <img
          ...
          <Carousel.Item>
            <Carousel.Caption>
              ...
              <p>Mercedes-Benz is one of the largest manufacturers of premium passenger cars. In 2019 it sold 2.4 million cars and 438,000 vans.</p>
            </Carousel.Caption>
            <img
              className="d-block w-10"
          ...
          <Carousel.Item>
            <Carousel.Caption>
              ...
              <p>CPM is in the business of People. On a global scale, our exceptional contact centre employees have been providing sales and service solutions for our clients for over 40 years</p>
            </Carousel.Caption>
            <img
              className="d-block w-10"
          ...
          <Carousel.Item>
            <Carousel.Caption>
              ...
              <p>Founded in 2011, Rover is the world's largest network of 5-star pet sitters and dog walkers.</p>
            </Carousel.Caption>
            <img
              className="d-block w-10"
        ...
        <Container>
          <Row>
            <Col>
            <h5 clasName="webdescription">During COVID19 many companies have been forced to reduce their workforce on a large scale leaving professionals and talented people without a job. This website is intended to help your company to find the talent that you need. In here, the individuals are presented only by their experience and skills, for futher information do not hesitate to contact them.</h5>
            </Col>
          </Row>
        </Container>
              ...
              <div className= "col-md-4" key={candidate.id}>
               <Col sm={12}>
                 <Card style={{ width: '18rem' }}>
                   <Card.Body>
                   <Card.Title>Language</Card.Title>{candidate.mother_tongue}
